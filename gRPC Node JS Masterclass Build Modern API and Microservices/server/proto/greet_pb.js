...
goog.exportSymbol('proto.greet.GreetRepsonse', null, global);
 ...
 * @constructor
 */
proto.greet.GreetRepsonse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.greet.GreetRepsonse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.greet.GreetRepsonse.displayName = 'proto.greet.GreetRepsonse';
}
 ...
 * @return {?proto.greet.Greeting}
 */
proto.greet.GreetRequest.prototype.getGreet = function() {
...
*/
proto.greet.GreetRequest.prototype.setGreet = function(value) {
 ...
 * @return {!proto.greet.GreetRequest} returns this
 */
proto.greet.GreetRequest.prototype.clearGreet = function() {
 ...
 * @return {boolean}
 */
proto.greet.GreetRequest.prototype.hasGreet = function() {
 ...
 * @return {!Object}
 */
proto.greet.GreetRepsonse.prototype.toObject = function(opt_includeInstance) {
  return proto.greet.GreetRepsonse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.greet.GreetRepsonse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.GreetRepsonse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.greet.GreetRepsonse}
 */
proto.greet.GreetRepsonse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.greet.GreetRepsonse;
  return proto.greet.GreetRepsonse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.greet.GreetRepsonse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.greet.GreetRepsonse}
 */
proto.greet.GreetRepsonse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.greet.GreetRepsonse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.greet.GreetRepsonse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.greet.GreetRepsonse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.greet.GreetRepsonse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getResult();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.greet.GreetRepsonse.prototype.getResult = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.greet.GreetRepsonse} returns this
 */
proto.greet.GreetRepsonse.prototype.setResult = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
